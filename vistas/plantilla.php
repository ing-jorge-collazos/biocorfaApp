...
<head>
  ...
  <title>Biocorfa | Biocosmetica Corporal y Facial</title>
   ...
   echo '<div class="wrapper">';
    ...
    if(isset($_GET["ruta"])){
      ...
      if($_GET["ruta"] == "inicio" ||
         ...
         $_GET["ruta"] == "clientes" ||
         $_GET["ruta"] == "ventas" ||
         $_GET["ruta"] == "agendamiento" ||
         $_GET["ruta"] == "crear-venta" ||
         $_GET["ruta"] == "editar-venta" ||
         $_GET["ruta"] == "reportes" ||
         $_GET["ruta"] == "antecedentes" ||
         $_GET["ruta"] == "examen-fisico" ||
         $_GET["ruta"] == "salir"){
...
<script src="vistas/js/medios.js"></script>
<script src="vistas/js/sedes.js"></script>
<script src="vistas/js/productos.js"></script>
<script src="vistas/js/clientes.js"></script>
<script src="vistas/js/antecedentes.js"></script>
