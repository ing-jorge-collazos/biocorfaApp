              ...
              <div class="box">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <option type="text" class="form-control" id="nuevoVendedor" value="<?php echo $_SESSION["nombre"]; ?>"></option>
                      <option type="hidden" name="idVendedor" value="<?php echo $_SESSION["id"]; ?>">
                    </option>
